  ...
  <section id="contact-form" class="py-3">
    ...
    <section id="czarownica-info">
      <div class="czarownica-content">
        ...
        <p></p>
        <img src="img/makrama1.jpeg" alt="" width="40%">
        <img src="img/makrama2.jpeg" alt="" width="40%">
        <br>
    ...
    <section id="czarownica-info">
      <div class="czarownica-content">
        ...
        <p></p>
        <img src="img/doniczka1.jpeg" alt="" width="40%">
        <img src="img/doniczka2.jpeg" alt="" width="40%">
        <br>
    ...
    <section id="czarownica-info">
      <div class="czarownica-content">
        ...
        <h5>Makrama Naścienna</h5>
        <p></p>
        <img src="img/mandala4.jpg" alt="" width="40%">
        <img src="img/mandala3.jpg" alt="" width="40%">
        <br>
